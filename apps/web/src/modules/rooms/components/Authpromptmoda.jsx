...
export default function AuthPromptModal({ isOpen, onClose, message }) {
  ...
  const defaultMessage =
    message || "Join the community to react, save, and discuss films with cinephiles worldwide.";
  ...
  return (
    <>
      ...
      >
        ...
        {/* Decorative floating film icons */}
        <div
          style={{
            position: "absolute",
            top: 18,
        ...
        <div style={{ padding: "28px 28px 24px" }}>
          ...
          >
            {[
              { emoji: "🎬", label: "Host Rooms" },
              { emoji: "🎥", label: "Join Parties" },
              { emoji: "💬", label: "Discuss Films" },
            ].map((f) => (
              <div
                key={f.label}
                style={{
