...
function DiscussionCard({ room }) {
  ...
  }, [isLoggedIn, room.id, inviteCode, navigate]);
          ...
          {errorMessage ? (
            ...
            <>
              {!room.backdrop || imgError || !imgLoaded ? (
                <div className="w-full h-full bg-gradient-to-br from-[#1a2e1a] to-[#12121e] flex items-center justify-center animate-pulse">
              ...
              <div className="absolute top-3 left-3 bg-[#22c55e] text-white text-[10px] px-2 py-[2px] rounded-full">
                💬 DISCUSSION
              </div>
            </>
          )}
            ...
            <>
              {!followDataReady ? (
                ...
                <button
                  ...
                  style={{
                    background: isFollowing ? "rgba(34,197,94,0.08)" : "rgba(34,197,94,0.14)",
                    border: `1px solid ${isFollowing ? "rgba(34,197,94,0.3)" : "rgba(34,197,94,0.5)"}`,
                    color: isFollowing ? "rgba(134,239,172,0.7)" : "#86efac",
                ...
                >
                  {loadingFollow ? (
                    <>
                      <span
                        className="w-[11px] h-[11px] rounded-full border-2 border-[#86efac]/30 border-t-[#86efac] inline-block"
