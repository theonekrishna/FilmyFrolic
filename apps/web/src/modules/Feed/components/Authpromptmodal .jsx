...
export default function AuthPromptModal({ isOpen, onClose, message }) {
  ...
  const defaultMessage =
    message ||
    "Sign in to explore trending posts, react to updates, join discussions, and personalize your feed experience.";
  ...
  return (
    <>
      ...
      >
        ...
        {/* Decorative floating feed icons */}
        <div
          style={{
            position: "absolute",
            top: 18,
        ...
        <div style={{ padding: "28px 28px 24px" }}>
          ...
          >
            ...
            >
              ...
              >
                <Sparkles size={26} color="#f5c518" strokeWidth={2.2} />
              </div>
          ...
          >
            {[
              { emoji: "🔥", label: "Trending Posts" },
              { emoji: "❤️", label: "React Instantly" },
              { emoji: "💬", label: "Join Discussions" },
            ].map((f) => (
              <div
                key={f.label}
                style={{
