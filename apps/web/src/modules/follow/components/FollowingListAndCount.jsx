...
/**
 * FollowingListAndCount
 *
 * Displays a list of users the given userId follows.
 *
 * Props:
 *   userId   {string}   — whose following list to show
 *   onClose  {function} — called when user wants to close/dismiss
 */
export default function FollowingListAndCount({ userId, onClose }) {
