function GoogleButton({ onClick, disabled }) {
  return (
    <button
      ...
      hover:bg-white/10 transition text-gray-200 font-semibold ${disabled ? "opacity-50 cursor-not-allowed" : ""}`}
    >
      <svg width="18" height="18" viewBox="0 0 24 24">
        ...
        />
        <path
          d="M5.84 14.09A6.96 6.96 0 0 1 5.49 12
          c0-.73.13-1.43.35-2.09V7.07H2.18
          A11.96 11.96 0 0 0 1 12
          c0 1.78.43 3.45 1.18 4.93l3.66-2.84z"
          fill="#FBBC05"
        />
        <path
          d="M12 5.38c1.62 0 3.06.56 4.21
          1.64l3.15-3.15C17.45 2.09
          14.97 1 12 1
          7.7 1 3.99 3.47
          2.18 7.07l3.66 2.84
