...
export default function AuthPromptModal({ isOpen, onClose, message }) {
  ...
  const defaultMessage =
    message ||
    "Join the gossip community to share rumors, react to trending stories, and discuss celebrity buzz with others.";
    ...
    <>
      ...
      >
        ...
        <div style={{ padding: "28px 28px 24px" }}>
          ...
          >
            {[
              { emoji: "🔥", label: "Share gossip" },
              { emoji: "😱", label: "React to rumors" },
